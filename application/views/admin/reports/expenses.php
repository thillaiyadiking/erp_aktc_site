                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed table-hover"
                                ...
                                <thead>
                                    <tr>
                                        <th class="bold"><?php echo _l('payment_mode'); ?></th>
                                        <?php
                                        for ($m = 1; $m <= 12; $m++) {
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td class="bold"><?php echo $payment_mode['name'] ?></td>
                                            <?php
                                            for ($m = 1; $m <= 12; $m++) {
                                                ...
                                                $this->db->select('id')
                                                    ...
                                                    ->where('clientid', $payment_mode['id'])
                                                ...
                                                if (!isset($totalNetByExpenseCategory[$payment_mode['id']])) {
                                                    $totalNetByExpenseCategory[$payment_mode['id']] = [];
                                                }
                                                array_push($totalNetByExpenseCategory[$payment_mode['id']], $total_expenses);
                                            ...
                                            <td class="tw-bg-neutral-50">
                                                <?php echo app_format_money(array_sum($totalNetByExpenseCategory[$payment_mode['id']]), $_currency); ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed table-hover"
                                ...
                                <thead>
                                    <tr>
                                        <th class="bold"><?php echo _l('suppliers'); ?></th>
                                        <?php
                                        for ($m = 1; $m <= 12; $m++) {
                                            echo '  <th class="bold">' . _l(date('F', mktime(0, 0, 0, $m, 1))) . '</th>';
                                        }
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td class="bold"><?php echo $suppliers['company'] ?></td>
                                            <?php
                                            for ($m = 1; $m <= 12; $m++) {
                                                // Set the monthly total expenses array
                                                if (!isset($netMonthlyTotal[$m])) {
                                                ...
                                                $this->db->select('id')
                                                    ...
                                                    ->where('MONTH(date)', $m)
                                                    ->where('YEAR(date)', $current_year)
                                                    ->where('clientid', $suppliers['userid'])
                                                    ->where('currency', $_currency->id);
                                                ...
                                                // Add to total monthy expenses
                                                array_push($netMonthlyTotal[$m], $total_expenses);
                                                if (!isset($totalNetByExpenseCategory[$suppliers['userid']])) {
                                                    $totalNetByExpenseCategory[$suppliers['userid']] = [];
                                                }
                                                array_push($totalNetByExpenseCategory[$suppliers['userid']], $total_expenses);
                                                // Output the total for this category
                                                if (count($categories) <= 8) {
                                                    echo app_format_money($total_expenses, $_currency);
                                                } else {
                                            ...
                                            <td class="tw-bg-neutral-50">
                                                <?php echo app_format_money(array_sum($totalNetByExpenseCategory[$suppliers['userid']]), $_currency); ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed table-hover"
                                ...
                                <thead>
                                    <tr>
                                        <th class="bold"><?php echo _l('projects'); ?></th>
                                        <?php
                                        for ($m = 1; $m <= 12; $m++) {
                                            echo '  <th class="bold">' . _l(date('F', mktime(0, 0, 0, $m, 1))) . '</th>';
                                        }
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td class="bold"><?php echo $projects['name'] ?></td>
                                            <?php
                                            for ($m = 1; $m <= 12; $m++) {
                                                // Set the monthly total expenses array
                                                if (!isset($netMonthlyTotal[$m])) {
                                                ...
                                                // Add to total monthy expenses
                                                array_push($netMonthlyTotal[$m], $total_expenses);
                                                if (!isset($totalNetByExpenseCategory[$projects['id']])) {
                                                    $totalNetByExpenseCategory[$projects['id']] = [];
                                                }
                                                array_push($totalNetByExpenseCategory[$projects['id']], $total_expenses);
                                                // Output the total for this category
                                                if (count($categories) <= 8) {
                                                    echo app_format_money($total_expenses, $_currency);
                                                } else {
                                            ...
                                            <td class="tw-bg-neutral-50">
                                                <?php echo app_format_money(array_sum($totalNetByExpenseCategory[$projects['id']]), $_currency); ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed table-hover"
                                ...
                                <thead>
                                    <tr>
                                        <th class="bold"><?php echo _l('customer_or_company'); ?></th>
                                        <?php
                                        for ($m = 1; $m <= 12; $m++) {
                                            echo '  <th class="bold">' . _l(date('F', mktime(0, 0, 0, $m, 1))) . '</th>';
                                        }
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td class="bold"><?php echo $customer['company'] ?></td>
                                            <?php
                                            for ($m = 1; $m <= 12; $m++) {
                                                // Set the monthly total expenses array
                                                if (!isset($netMonthlyTotal[$m])) {
                                                ...
                                                $this->db->select('id')
                                                    ...
                                                    ->where('MONTH(date)', $m)
                                                    ->where('YEAR(date)', $current_year)
                                                    ->where('clientid', $customer['userid'])
                                                    ->where('currency', $_currency->id);
                                                ...
                                                // Add to total monthy expenses
                                                array_push($netMonthlyTotal[$m], $total_expenses);
                                                if (!isset($totalNetByExpenseCategory[$customer['userid']])) {
                                                    $totalNetByExpenseCategory[$customer['userid']] = [];
                                                }
                                                array_push($totalNetByExpenseCategory[$customer['userid']], $total_expenses);
                                                // Output the total for this category
                                                if (count($categories) <= 8) {
                                                    echo app_format_money($total_expenses, $_currency);
                                                } else {
                                            ...
                                            <td class="tw-bg-neutral-50">
                                                <?php echo app_format_money(array_sum($totalNetByExpenseCategory[$customer['userid']]), $_currency); ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed table-hover"
                                ...
                                <thead>
                                    <tr>
                                        <th class="bold"><?php echo _l('recipient_staff'); ?></th>
                                        <?php
                                        for ($m = 1; $m <= 12; $m++) {
                                            echo '  <th class="bold">' . _l(date('F', mktime(0, 0, 0, $m, 1))) . '</th>';
                                        }
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td class="bold"><?php echo $staff['firstname'] . ' ' . $staff['lastname']; ?></td>
                                            <?php
                                            for ($m = 1; $m <= 12; $m++) {
                                                // Set the monthly total expenses array
                                                if (!isset($netMonthlyTotal[$m])) {
                                                ...
                                                $this->db->select('id')
                                                    ...
                                                    ->where('MONTH(date)', $m)
                                                    ->where('YEAR(date)', $current_year)
                                                    ->where('recipient_staff', $staff['staffid'])
                                                    ->where('currency', $_currency->id);
                                                ...
                                                // Add to total monthy expenses
                                                array_push($netMonthlyTotal[$m], $total_expenses);
                                                if (!isset($totalNetByExpenseCategory[$staff['staffid']])) {
                                                    $totalNetByExpenseCategory[$staff['staffid']] = [];
                                                }
                                                array_push($totalNetByExpenseCategory[$staff['staffid']], $total_expenses);
                                                // Output the total for this category
                                                if (count($categories) <= 8) {
                                                    echo app_format_money($total_expenses, $_currency);
                                                } else {
                                            ...
                                            <td class="tw-bg-neutral-50">
                                                <?php echo app_format_money(array_sum($totalNetByExpenseCategory[$staff['staffid']]), $_currency); ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed table-hover"
                                ...
                                <thead>
                                    <tr>
                                        <th class="bold"><?php echo _l('purchased_staff'); ?></th>
                                        <?php
                                        for ($m = 1; $m <= 12; $m++) {
                                            echo '  <th class="bold">' . _l(date('F', mktime(0, 0, 0, $m, 1))) . '</th>';
                                        }
                                        ...
                                        <tr>
                                            ...
                                            for ($m = 1; $m <= 12; $m++) {
                                                ...
                                                $this->db->select('id')
                                                    ...
                                                    ->where('MONTH(date)', $m)
                                                    ->where('YEAR(date)', $current_year)
                                                    ->where('purchased_staff', $staff['staffid'])
                                                    ->where('currency', $_currency->id);
