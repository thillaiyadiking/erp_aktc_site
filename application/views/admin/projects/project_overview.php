                    ...
                    <div class="col-md-12">
                        ...
                        <dl class="tw-grid tw-grid-cols-1 tw-gap-x-4 tw-gap-y-5 sm:tw-grid-cols-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <?php if (!empty($project->g_map_locations)) { ?>
                                        <?php
                                        ...
                                        if (is_array($locations)) {
                                            foreach ($locations as $index => $loc) {
                                                ...
                                                if (!empty($mapUrl)) {
                                        ?>
                                                    <div class="sm:tw-col-span-1 project-overview-deadline mb-3">
                                                        <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                                                            <?php echo _l('google_map_address'); ?> <?php echo $index; ?>
                                                        </dt>
                                                        <dd class="tw-mt-1 tw-text-sm tw-text-neutral-900 d-flex align-items-center gap-2">
                                                            <?php if (!empty($note)) { ?>
                                                                <p class="tw-mb-0 tw-text-gray-700">
                                                            ...
                                                            <a href="<?php echo htmlspecialchars($mapUrl); ?>"
                                                                ...
                                                                <i class="fa-solid fa-diamond-turn-right" style="font-size: xx-large;"></i>
                                                            </a>
                                                        </dd>
                                                    </div>
                                        <?php
