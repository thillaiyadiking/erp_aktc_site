...
<div id="header">
    ...
    <nav>
        <div class="tw-flex tw-justify-between" >
            <div class="tw-flex tw-flex-1 sm:tw-flex-initial" id='top_search_quick'>
                <div id="top_search"
                    class="tw-inline-flex tw-relative dropdown sm:tw-ml-1.5 sm:tw-mr-3 tw-max-w-xl tw-flex-auto visible-md visible-lg"
            ...
            <?php if (isset($branch_det)){ ?>
                <div>
                    <!-- Variable Name  <h3><?php echo$branch_det->branch_name; ?></h3>  <!-- يمكن إغلاقه لأنه يطلع خطأ بعد إضافة قائمة الفروع في القائمة الخارجية لبعض الإضافات اللمسة النهائية --> <!--  Variable Name  <h3><?php echo$branch_det->branch_name; ?></h3> -->
                </div>
            <?php } ?>
