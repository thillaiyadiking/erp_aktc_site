                        ...
                        <div class="tab-content tw-mt-5">
                            <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                                ...
                                <?php if (is_admin() || is_branchadmin()) { ?>
                                    <div class="form-group select-placeholder">
                                        <label for="branch_assignment"><?php echo _l('Assign to'); ?></label>
                                        <select class="selectpicker"
                                            data-none-selected-text="<?php echo _l('Select'); ?>"
                                            data-width="100%" name="branch_assignment[]" id="branch_assignment" multiple>
                                            <?php foreach ($branches as $br) { ?>
                                                <option value=<?php echo $br->branch_id;
                                                                if (isset($assigned_branches)) {
                                                                    if (in_array($br->branch_id, $assigned_branches)) {
                                                                        echo ' selected';
                                                                    }
                                                                } ?>>
                                ...
                                <?php
                                $locations = [];
                                if (!empty($member->g_map_locations)) {
                                    $locations = json_decode($member->g_map_locations, true);
                                }
                                ?>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        ...
                                        <?php if (!empty($member->g_map_locations)) { ?>
                                            <?php
                                            $locations = json_decode($member->g_map_locations, true);
                                        ...
                                        <?php if (is_admin()) { ?>
                                            <div class="checkbox checkbox-primary">
                                                ...
                                                <input type="checkbox" name="administrator" id="administrator"
                                                    <?php echo $isadmin; ?> <?php if (isset($member) && ($member->admin == '1')) echo 'disabled'; ?>>
                                                <label
