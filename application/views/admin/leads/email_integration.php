...
<div id="wrapper">
            ...
            <div class="col-md-12">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?php echo form_open(uri_string(), ['id' => 'leads-email-integration']); ?>
    ...
    echo 'checked';
                           ...
                           if (!empty($ps)) {
                               ...
                               // After loading, access the library via $CI->encryption
                               if (!isset($CI->encryption)) {
                                   // Fallback in case the library did not load as a property
                                   $encryption = $CI->load->library('encryption', null, 'encryption');
                               } else {
                                   $encryption = $CI->encryption;
                               }
                               if (false == $encryption->decrypt($ps)) {
                                   // Do nothing, keep $ps as is
                               } else {
                                   $ps = $encryption->decrypt($ps);
                               }
                           }
