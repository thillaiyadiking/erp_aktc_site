...
$generatedString = GenerateQrCode::fromArray([
    new Seller(get_option('invoice_company_name')),
    new TaxNumber($vat_number),
    new InvoiceDate($invoiceDate->format('Y-m-d H:i:s')),
...
$logo = Logo::create(__DIR__ . '/zatca_phase_qr/logo.png')
    ->setResizeToWidth(50)
    ->setPunchoutBackground(true);

$label = Label::create('Qr Phase-1 fff')
    ->setTextColor(new Color(255, 0, 0));

$result = $writer->write($qrCode);
$savePath = FCPATH . 'uploads/zatca_phase_qr/';

// Create directory if it does not exist
if (!is_dir($savePath)) {
    mkdir($savePath, 0755, true); // true allows recursive creation
}

$result->saveToFile($savePath . 'phase-1.png');
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4"></div>
                    <div class="col-md-4">
                        <img src="<?= base_url('uploads/zatca_phase_qr/phase-1.png') ?>" alt="">
                    </div>
                </div>
                <?php
