...
class Dashboard extends AdminController
{
    ...
    public function index(){
        ...
        $staff_branches = $this->Staff_model->get_assigned_branches(get_staff_user_id());
        $assigned=[];
        foreach($staff_branches as $br){
            $det = $this->Branches_model->get($br->branch_id);
            array_push($assigned,$det);
            
        }
        $data['branches'] = $assigned;          
        
        $data['title'] =  _l('als_maindashboard');
        
        $this->load->view('admin/dashboard/main_dashboard',$data);
    }
    /* This is branch dashboard view */
    public function branch_dashboard($id=''){
    //public function index($id='')
        ...
        //$data['branch_clients'] = $this->Clients_model->clients_in_branch();
