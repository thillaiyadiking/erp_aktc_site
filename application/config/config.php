...
if (file_exists(APPPATH . 'config/app-config.php')) {
    ...
    $install_url .= 'install';
    echo '<h1>Finishizer ERP not installed</h1>';
    echo '<p>1. To you use the automatic Finishizer ERP installation tool click <a href="' . $install_url . '">here (' . $install_url . ')</a></p>';
