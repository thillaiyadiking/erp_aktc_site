 ...
 * @property bool $erpEnabled
 * @property string $erpType
 * @property string $erpCallbackUrl
 * @property string $erpFallbackUrl
 * @property array $erpAttributes
...
class ConfigurationInstance extends InstanceResource {
    ...
    public function __construct(Version $version, array $payload) {
        ...
        $this->properties = [
            ...
            'erpEnabled' => Values::array_get($payload, 'erp_enabled'),
            'erpType' => Values::array_get($payload, 'erp_type'),
            'erpCallbackUrl' => Values::array_get($payload, 'erp_callback_url'),
            'erpFallbackUrl' => Values::array_get($payload, 'erp_fallback_url'),
            'erpAttributes' => Values::array_get($payload, 'erp_attributes'),
