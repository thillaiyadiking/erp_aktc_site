...
class Migration_Version_250 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if ($theme != 'finishizer') {
            @copy(APPPATH . 'views/themes/finishizer/template_parts/contracts_table.php', APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/contracts_table.php');

            @copy(APPPATH . 'views/themes/finishizer/template_parts/projects/project_contracts.php', APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/projects/project_contracts.php');
        }
