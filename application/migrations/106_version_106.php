...
/*        if(!is_dir(BACKUPS_FOLDER)){
        ...
        if($theme != 'finishizer'){
            copy(APPPATH . 'views/themes/finishizer/template_parts/contract_attachments.php',APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/contract_attachments.php');
        }
