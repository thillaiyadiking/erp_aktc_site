...
/**
 * Tasks Model
 * Handles tasks related database operations.
 * 
 * $lang['task_status_1']             = 'Suggestions';
 * $lang['task_status_2']             = 'Estimate/Quote';
 * $lang['task_status_3']             = 'Down Payment';
 * $lang['task_status_4']             = 'Site Survey/Measurements';
 * $lang['task_status_5']             = 'Measurement Verification';
 * $lang['task_status_6']             = 'Create Plans and Approval';
 * $lang['task_status_7']             = 'Order Cancelled';
 * $lang['task_status_8']             = 'Send to Production/Cutting';
 * $lang['task_status_9']             = 'Ready for Pickup/Delivery';
 * $lang['task_status_10']            = 'Installation Started';
 * $lang['task_status_11']            = 'Site Issues';
 * $lang['task_status_20']            = 'Completed';
 *
 */ /*إضافات من اللمسة النهائية*/
class Tasks_model extends App_Model
{
    ...
    const STATUS_AWAITING_FEEDBACK = 4;

    const MEASUREMENT_VERIFICATION = 5; /* إضافة اللمسة النهائية */

    const CREATE_PLANS_AND_APPROVAL = 6; /* إضافة اللمسة النهائية */

    const ORDER_CANCELLED = 7; /* إضافة اللمسة النهائية */

    const SEND_TO_PRODUCTION_CUTTING = 8; /* إضافة اللمسة النهائية */

    const READY_FOR_PICKUP_DELIVERY = 9; /* إضافة اللمسة النهائية */

    const INSTALLATION_STARTED = 10; /* إضافة اللمسة النهائية */

    const SITE_ISSUES = 11; /* إضافة اللمسة النهائية */
    ...
    public function get_statuses()
    {
        $statuses = hooks()->apply_filters('before_get_task_statuses', [
            ...
            [
                'id'             => static::MEASUREMENT_VERIFICATION,
                'color'          => '#f97316',
            ...
            [
                'id'             => static::CREATE_PLANS_AND_APPROVAL,
                'color'          => '#eab308',
            ...
            [
                'id'             => static::SEND_TO_PRODUCTION_CUTTING,
                'color'          => '#f59e0b',
            ...
            [
                'id'             => static::READY_FOR_PICKUP_DELIVERY,
                'color'          => '#10b981',
            ...
            [
                'id'             => static::INSTALLATION_STARTED,
                'color'          => '#ec4899',
