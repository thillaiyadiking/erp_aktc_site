    ...
    public function get_project_statuses()
    {
        $statuses = hooks()->apply_filters('before_get_project_statuses', [
            ...
            [
                'id'             => 6,
                'color'          => '#94a3b8',
                'name'           => _l('project_status_6'), /* إضافة من اللمسة النهائية*/
                'order'          => 5,
                'filter_default' => false,
            ],
            [
                'id'             => 7,
                'color'          => '#94a3b8',
                'name'           => _l('project_status_7'), /* إضافة من اللمسة النهائية*/
                'order'          => 7,
                'filter_default' => false,
            ],
            [
                'id'             => 8,
                'color'          => '#94a3b8',
                'name'           => _l('project_status_8'), /* إضافة من اللمسة النهائية*/
                'order'          => 8,
                'filter_default' => false,
            ],
            [
                'id'             => 9,
                'color'          => '#94a3b8',
                'name'           => _l('project_status_9'), /* إضافة من اللمسة النهائية*/
                'order'          => 9,
                'filter_default' => false,
            ],
            [
                'id'             => 10,
                'color'          => '#94a3b8',
                'name'           => _l('project_status_10'), /* إضافة من اللمسة النهائية*/
                'order'          => 10,
                'filter_default' => false,
            ],
            [
                'id'             => 11,
                'color'          => '#94a3b8',
                'name'           => _l('project_status_11'), /* إضافة من اللمسة النهائية*/
                'order'          => 11,
                'filter_default' => false,
            ],
            [
                'id'             => 20,
                'color'          => '#94a3b8',
                'name'           => _l('project_status_20'), /* إضافة من اللمسة النهائية*/
                'order'          => 100,
                'filter_default' => false,
            ],
