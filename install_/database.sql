...
CREATE TABLE `tblbranches` (
  ...
  `branch_country` int NOT NULL DEFAULT '0',
...
CREATE TABLE `tblclients` (
  `userid` int NOT NULL,
  'is_supplier' INT(10) NOT NULL DEFAULT '0', /* إضافة اللمسة النهائية*/
  `company` varchar(191) DEFAULT NULL,
  'commercial_reg_num' VARCHAR(255) NULL, /* إضافة اللمسة النهائية*/
...
CREATE TABLE `tblexpenses` (
  `id` int NOT NULL,
  `branch_id` int NOT NULL,
  'is_supplier' INT(10), /* إضافة اللمسة النهائية*/
  ...
  `clientid` int NOT NULL,
  `purchased_staff` int NOT NULL,
  `recipient_staff` int NOT NULL,
  `project_id` int NOT NULL DEFAULT '0',
