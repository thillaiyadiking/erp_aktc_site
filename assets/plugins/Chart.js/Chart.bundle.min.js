        ...
        function (e, n, i) {
          !(function (e, a) {
            ...
            function Wt(t, e, n) {
              ...
              return n
                ? "dddd" === e
                  ? ((a = ha.call(this._weekdaysParse, o)), -1 !== a ? a : null)
                  : "ddd" === e
            ...
            function Yt(t) {
              ...
              return null != t
                ? ((t = Ft(t, this.localeData())), this.add(t - e, "d"))
                : e;
            }
            function Bt(t) {
              if (!this.isValid()) return null != t ? this : NaN;
              ...
              if (null !== e) {
                ...
                if (((e.abbr = t), null != Ia[t]))
                  ...
                  if (null == Ia[e.parentLocale])
                    return (
                      Fa[e.parentLocale] || (Fa[e.parentLocale] = []),
                      Fa[e.parentLocale].push({ name: t, config: e }),
                      null
                    );
                ...
                n &&
                  ...
                  ((e =
                    n[aa] < 0 || n[aa] > 11
                      ...
                      ? ua
                      : -1),
                  g(t)._overflowDayOfYear && (ia > e || e > ra) && (e = ra),
                  g(t)._overflowWeeks && -1 === e && (e = da),
                  g(t)._overflowWeekday && -1 === e && (e = ca),
                  (g(t).overflow = e)),
                t
              );
            }
              ...
              (t.controllers.bar = t.DatasetController.extend({
                ...
                calculateBarX: function (t, e, n) {
                  ...
                  return (
                    ...
                    r.options.stacked
                      ? s + n.categoryWidth / 2 + n.categorySpacing
                      : s +
                        n.barWidth / 2 +
                        n.categorySpacing +
                        n.barWidth * o +
              ...
              (t.controllers.horizontalBar = t.controllers.bar.extend({
                ...
                calculateBarY: function (t, e, n) {
                  ...
                  return (
                    ...
                    r.options.stacked
                      ? s + n.categoryHeight / 2 + n.categorySpacing
                      : s +
                        n.barHeight / 2 +
                        n.categorySpacing +
                        n.barHeight * o +
                  ...
                  l && u
                    ? (o.retinaScale(i),
                      s.options.responsive &&
                        (o.addResizeListener(u.parentNode, function () {
                          s.resize();
                        }),
                        s.resize(!0)),
                      s.initialize(),
              ...
              o.extend(t.Controller.prototype, {
                ...
                update: function (e, n) {
                  ...
                  o.each(
                    ...
                    i._bufferedRender
                      ? (i._bufferedRequest = { lazy: n, duration: e })
                      : i.render(e, n);
                },
                ...
                render: function (e, n) {
                  ...
                  if (
                    ...
                    (("undefined" != typeof e && 0 !== e) ||
                      ("undefined" == typeof e && 0 !== a.duration))
                  ) {
                    var r = new t.Animation();
                    (r.numSteps = (e || a.duration) / 16.66),
                      (r.easing = a.easing),
                      ...
                      (r.onAnimationProgress = a.onProgress),
                      (r.onAnimationComplete = a.onComplete),
                      t.animationService.addAnimation(i, r, e, n);
                  } else
                    i.draw(),
                      a &&
                        a.onComplete &&
                ...
                draw: function (e) {
                  var n = this,
                    i = e || 1;
                  n.clear(),
                    t.plugins.notify("beforeDraw", [n, i]),
                    o.each(
                      n.boxes,
                      function (t) {
                        t.draw(n.chartArea);
                    ...
                    t.plugins.notify("beforeDatasetsDraw", [n, i]),
                    o.each(
                      n.data.datasets,
                      function (t, i) {
                    ...
                    t.plugins.notify("afterDatasetsDraw", [n, i]),
                    n.tooltip.transition(i).draw(),
                    t.plugins.notify("afterDraw", [n, i]);
                },
                ...
                destroy: function () {
                  var e,
                    ...
                    r = this,
                    s = r.chart.canvas;
                  for (r.stop(), n = 0, a = r.data.datasets.length; a > n; ++n)
                    (e = r.getDatasetMeta(n)),
                      e.controller &&
                        (e.controller.destroy(), (e.controller = null));
                  s &&
                    (o.unbindEvents(r, r.events),
                    o.removeResizeListener(s.parentNode),
                    o.clear(r.chart),
                    i(s),
                    (r.chart.canvas = null),
                    (r.chart.ctx = null)),
                    t.plugins.notify("destroy", [r]),
                ...
                eventHandler: function (t) {
                  ...
                  return (
                    o
                      ...
                      : r &&
                        !e.animating &&
                        (e.stop(), e.render(a.animationDuration, !0)),
                    (e._bufferedRender = !1),
                  ...
                  (i = o[e]),
                    i.model.skip ||
                      ...
                      a &&
                        !a.model.skip &&
                        (i.deltaK =
                          (a.model.y - i.model.y) / (a.model.x - i.model.x)),
                      !n || n.model.skip
                        ? (i.mK = i.deltaK)
                        : !a || a.model.skip
                        ? (i.mK = n.deltaK)
            ...
            t.layoutService = {
              ...
              update: function (t, n, i) {
                ...
                function r(t) {
                  ...
                  if (n)
                    if (t.isHorizontal()) {
                      var i = { left: T, right: P, top: 0, bottom: 0 };
                ...
                function o(t) {
                  var n = e.findNextWhere(C, function (e) {
                    ...
                    i = { left: 0, right: 0, top: I, bottom: F };
                  n && t.update(n.minSize.width, D, i);
                }
                function s(t) {
                  t.isHorizontal()
                    ? ((t.left = t.options.fullWidth ? d : T),
                      (t.right = t.options.fullWidth ? n - c : T + M),
                      (t.top = L),
                      (t.bottom = L + t.height),
                      (L = t.bottom))
                    : ((t.left = R),
            ...
            (t.defaults.global.legend = {
                ...
                generateLabels: function (t) {
                  ...
                  return n.isArray(e.datasets)
                    ? e.datasets.map(function (e, i) {
                        return {
                          text: e.label,
                          fillStyle: n.isArray(e.backgroundColor)
                            ? e.backgroundColor[0]
                            : e.backgroundColor,
              ...
              (t.Legend = t.Element.extend({
                ...
                fit: function () {
                  ...
                  if (
                    (p
                      ? ((m.width = i.maxWidth), (m.height = o ? 10 : 0))
                      : ((m.width = o ? 10 : 0), (m.height = i.maxHeight)),
                    o)
                  )
                    if (((s.font = f), p)) {
                      ...
                      (s.textAlign = "left"),
                        ...
                        n.each(i.legendItems, function (t, n) {
                          ...
                          v[v.length - 1] + o + r.padding >= i.width &&
                            ((b += d + r.padding), (v[v.length] = i.left)),
                            (g[n] = { left: 0, top: 0, width: o, height: d }),
                    ...
                    n.each(i.legendItems, function (t, e) {
                      ...
                      _
                        ? o + a >= l &&
                          ((s = d.y += w),
                          d.line++,
                          (o = d.x = i.left + (l - u[d.line]) / 2))
                        : s + w > i.bottom &&
                          ((o = d.x = o + i.columnWidths[d.line] + r.padding),
                          (s = d.y = i.top),
                          d.line++),
                        x(o, s, t),
                        (y[e].left = o),
                ...
                calculateTickRotation: function () {
                  ...
                  if (
                    ...
                    for (
                      var f,
                        g,
                        m = e.longestText(i, u, n.ticks, n.longestTextCache),
                        p = m,
                        v = n.getPixelForTick(1) - n.getPixelForTick(0) - 6;
                      p > v && n.labelRotation < r.maxRotation;
                  ...
                  if (
                    (d
                      ? (i.width = n.isFullWidth()
                          ...
                          : n.maxWidth)
                      : (i.width = u && l.drawTicks ? p : 0),
                    d
                      ? (i.height = u && l.drawTicks ? p : 0)
                      : (i.height = n.maxHeight),
                    s.display &&
                      u &&
                      (d ? (i.height += 1.5 * m) : (i.width += 1.5 * m)),
                    o.display && u)
                  ) {
                    n.longestTextCache || (n.longestTextCache = {});
                    var v = e.longestText(
                    ...
                    if (d) {
                      ...
                      var x =
                        ...
                        c * b +
                        y * b;
                      (i.height = Math.min(n.maxHeight, i.height + x)),
                        (n.ctx.font = g);
                      ...
                      (n.paddingLeft =
                        0 !== n.labelRotation ? w * k + 3 : k / 2 + 3),
                        (n.paddingRight =
                          0 !== n.labelRotation ? S * (c / 2) + 3 : _ / 2 + 3);
                    } else {
                  ...
                  if (a.display) {
                    ...
                    if (g) {
                      if (
                        ((r = !1),
                        h && (I /= 2),
                        (I + u.autoSkipPadding) * i.ticks.length >
                    ...
                    if (
                        ...
                        if (void 0 !== t && null !== t) {
                          ...
                          if ((!l || s) && void 0 !== t && null !== t) {
                            ...
                            ("undefined" != typeof i.zeroLineIndex
                              ? i.zeroLineIndex
                              : 0)
                              ? ((c = d.zeroLineWidth), (f = d.zeroLineColor))
                              : ((c = e.getValueAtIndexOrDefault(
                                  d.lineWidth,
                                  o
                                )),
                                (f = e.getValueAtIndexOrDefault(d.color, o)));
                            var m,
                              p,
                              v,
                              b,
                            ...
                            if (g) {
                              h ||
                                (I = "top" === a.position ? "bottom" : "top"),
                                (P = h ? "right" : "center");
                              var W = i.getPixelForTick(o) + e.aliasPixel(c);
                              (D =
                                i.getPixelForTick(o, d.offsetGridLines) +
                                u.labelOffset),
                                (C = h
                                  ? i.top + 12
                                  : "top" === a.position
                              ...
                              "left" === a.position
                                ? u.mirror
                                  ? ((D = i.right + u.padding), (P = "left"))
                                  : ((D = i.right - u.padding), (P = "right"))
                                : u.mirror
                                ? ((D = i.left - u.padding), (P = "right"))
                                : ((D = i.left + u.padding), (P = "left"));
                              var V = i.getPixelForTick(o);
                              (V += e.aliasPixel(c)),
                                (C = i.getPixelForTick(o, d.offsetGridLines)),
                                (m = A),
                                (v = O),
                                (y = n.left),
                                (S = n.right),
                      ...
                      if (g)
                        ...
                        (W = B ? i.left + S / 2 : i.right - S / 2),
                          (V = i.top + (i.bottom - i.top) / 2),
                          (Y = B ? -0.5 * Math.PI : 0.5 * Math.PI);
                      }
                      s.save(),
                        s.translate(W, V),
                        s.rotate(Y),
                    ...
                    if (d.drawBorder) {
                      ...
                      g
                        ? ((H = E = "top" === a.position ? i.bottom : i.top),
                          (H += U),
                          (E += U))
                        : ((z = N = "left" === a.position ? i.right : i.left),
                          (z += U),
                          (N += U)),
                        s.beginPath(),
                        s.moveTo(z, H),
            ...
            t.Ticks = {
              generators: {
                linear: function (t, n) {
                  ...
                  var u = (s - o) / i;
                  (u = e.almostEquals(u, Math.round(u), i / 1e3)
                    ? Math.round(u)
                    : Math.ceil(u)),
                ...
                logarithmic: function (t, n) {
                  for (
                    var i = [],
                      ...
                      r = a(t.min, Math.pow(10, Math.floor(e.log10(n.min))));
                    r < n.max;
                    ...
                    var o, s;
                    0 === r
                      ? ((o = Math.floor(e.log10(n.minNotZero))),
                        (s = Math.round(n.minNotZero / Math.pow(10, o))))
                      : ((o = Math.floor(e.log10(r))),
                        (s = Math.floor(r / Math.pow(10, o)) + 1)),
                      10 === s && ((s = 1), ++o),
                      (r = s * Math.pow(10, o));
                  }
                  var l = a(t.max, r);
              ...
              (t.elements.Point = t.Element.extend({
                ...
                draw: function () {
                  var e = this._view,
                    ...
                    u = e.y;
                  e.skip ||
                    ((n.strokeStyle = e.borderColor || r),
                    (n.lineWidth = i.getValueOrDefault(
                      e.borderWidth,
                      a.elements.point.borderWidth
                    )),
                    (n.fillStyle = e.backgroundColor || r),
                    t.canvasHelpers.drawPoint(n, o, s, l, u));
                },
              }));
          };
        },
              ...
              i = t.Scale.extend({
                ...
                getLabelForIndex: function (t, e) {
                  var n = this,
                    i = n.chart.data,
                    a = n.isHorizontal();
                  return (i.xLabels && a) || (i.yLabels && !a)
                        ...
                        if (s > 0 || i.reverse) {
                          ...
                          if (a.display && 0 !== s)
                            if (
                              ...
                              (u.lineWidth = e.getValueAtIndexOrDefault(
                                a.lineWidth,
                                s - 1
                              )),
                              i.lineArc)
                              ...
                              u.beginPath(),
                                u.arc(t.xCenter, t.yCenter, c, 0, 2 * Math.PI),
                                u.closePath(),
                                u.stroke();
                            else {
                              u.beginPath();
                            ...
                            if (((u.font = f), r.showLabelBackdrop)) {
                              ...
                              (u.fillStyle = r.backdropColor),
                                u.fillRect(
                                  ...
                                  h - d / 2 - r.backdropPaddingY,
                                  v + 2 * r.backdropPaddingX,
                                  d + 2 * r.backdropPaddingY
                                );
                            }
                            (u.textAlign = "center"),
                              (u.textBaseline = "middle"),
                              (u.fillStyle = p),
                              u.fillText(o, t.xCenter, h);
                          }
                        }
                      }),
                      !i.lineArc)
