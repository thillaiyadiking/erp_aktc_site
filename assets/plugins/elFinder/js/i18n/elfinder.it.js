 ...
 * @author Alberto Tocci (alberto.tocci@mail.finishizer.net)
 * @author Claudio Nicora (coolsoft.ita@mail.finishizer.net)
 * @author Stefano Galeazzi <stefano.galeazzi@probanet.it>
 * @author Thomas Camaran <camaran@mail.finishizer.net>
 * @version 2018-06-08
 */
(function(root, factory) {
	...
	elFinder.prototype.i18.it = {
		translator : 'Alberto Tocci (alberto.tocci@mail.finishizer.net), Claudio Nicora (coolsoft.ita@mail.finishizer.net), Stefano Galeazzi &lt;stefano.galeazzi@probanet.it&gt;, Thomas Camaran &lt;camaran@mail.finishizer.net&gt;',
		language   : 'Italiano',
		direction  : 'ltr',
