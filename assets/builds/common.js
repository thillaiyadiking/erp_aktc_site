  ...
  (function (t) {
    t.fn.googleDrivePicker = function (e) {
      var n,
        i = !1,
        o = {
          initGooglePickerAPI: function (t) {
            gapi.load("auth2", function () {
              o.onAuthApiLoad(t);
            }),
              gapi.load("picker", o.onPickerApiLoad);
          },
          onAuthApiLoad: function (t) {
            (t.disabled = !1),
              t.addEventListener("click", function () {
                gapi.auth2.authorize(
                  { client_id: a.clientId, scope: a.scope },
                  o.handleAuthResult
                );
              });
          },
          ...
          handleAuthResult: function (t) {
            t && !t.error
              ? ((n = t.access_token), o.createPicker())
              : t.error && console.error(t);
          },
          createPicker: function () {
            if (i && n) {
              ...
              a.mimeTypes &&
                (e.setMimeTypes(a.mimeTypes), r.setMimeTypes(a.mimeTypes)),
                new google.picker.PickerBuilder()
                  .addView(e)
                  .addView(r)
                  .setOAuthToken(n)
                  .setDeveloperKey(a.developerKey)
                  .setCallback(o.pickerCallback)
                  .build()
                  .setVisible(!0),
                setTimeout(function () {
          ...
          pickerCallback: function (t) {
            if (
              t[google.picker.Response.ACTION] == google.picker.Action.PICKED
            ) {
              var e = [];
              t[google.picker.Response.DOCUMENTS].forEach(function (t) {
                ...
                "function" == typeof a.onPick
                  ? a.onPick(e)
                  : window[a.onPick](e);
            }
          },
        },
        a = t.extend({}, t.fn.googleDrivePicker.defaults, e);
      return this.each(function () {
        a.clientId
          ? (t(this).data("on-pick") && (a.onPick = t(this).data("on-pick")),
            o.initGooglePickerAPI(t(this)[0]),
