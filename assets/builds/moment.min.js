!(function (e, a) {
  ...
  function o(e, a) {
    ...
    return (
      u(a, "toString") && (e.toString = a.toString),
  ...
  function G(e, a) {
    ...
    for (N.lastIndex = 0; 0 <= t && N.test(e); )
      (e = e.replace(N, s)), (N.lastIndex = 0), (t -= 1);
    return e;
  }
  var B = /\d/,
    U = /\d\d/,
  ...
  function ye(e, a) {
    return function (s) {
      return null != s
        ? (pe(this, e, s), t.updateOffset(this, a), this)
        : fe(this, e);
    };
  }
  function fe(e, a) {
  ...
  function pe(e, a, t) {
    e.isValid() &&
      !isNaN(t) &&
      ("FullYear" === a && he(e.year()) && 1 === e.month() && 29 === e.date()
  ...
  function ke(e, a) {
    ...
    var t = ((a % 12) + 12) % 12;
    return (
      (e += (a - t) / 12), 1 === t ? (he(e) ? 29 : 28) : 31 - ((t % 7) % 2)
    );
  }
  ...
  function Ae(e) {
    return null != e
      ? (be(this, e), t.updateOffset(this, !0), this)
      : fe(this, "Month");
  }
  var we = ie,
    Se = ie;
  ...
  function je(e, a, t) {
    var s = 7 + a - t;
    return (-(7 + He(e, 0, s).getUTCDay() - a) % 7) + s - 1;
  }
  function Pe(e, a, t, s, n) {
    var r,
      i,
  ...
  function xe(e, a, t) {
    ...
    return (
      i < 1
        ? (s = i + Ee((n = e.year() - 1), a, t))
        : i > Ee(e.year(), a, t)
        ? ((s = i - Ee(e.year(), a, t)), (n = e.year() + 1))
        : ((n = e.year()), (s = i)),
      { week: s, year: n }
    );
  }
  ...
  function Re() {
    ...
    for (a = 0; a < 7; a++)
      (t = m([2e3, 1]).day(a)),
        ...
        u.push(n),
        u.push(r);
    for (i.sort(e), d.sort(e), _.sort(e), u.sort(e), a = 0; a < 7; a++)
      (d[a] = oe(d[a])), (_[a] = oe(_[a])), (u[a] = oe(u[a]));
  ...
  function $e(e) {
    var a = null;
    if (!Ve[e] && "undefined" != typeof module && module && module.exports)
      try {
        (a = Ue._abbr), require("./locale/" + e), Qe(a);
      } catch (e) {}
    return Ve[e];
  }
  function Qe(e, a) {
  ...
  function ea(e, a) {
    if (null === a) return delete Ve[e], null;
    var t,
      s = Ke;
    if (((a.abbr = e), null != Ve[e]))
      w(
      ...
      if (null != Ve[a.parentLocale]) s = Ve[a.parentLocale]._config;
      else {
        if (null == (t = $e(a.parentLocale)))
          return (
            Xe[a.parentLocale] || (Xe[a.parentLocale] = []),
            Xe[a.parentLocale].push({ name: e, config: a }),
            null
          );
        s = t._config;
      }
  ...
  function aa(e) {
    ...
    return (function (e) {
      for (var a, t, s, n, r = 0; r < e.length; ) {
        for (
          a = (n = Ze(e[r]).split("-")).length,
            t = (t = Ze(e[r + 1])) ? t.split("-") : null;
          0 < a;

        ) {
          if ((s = $e(n.slice(0, a).join("-")))) return s;
      ...
      t &&
        ...
        ((a =
          t[1] < 0 || 11 < t[1]
            ...
            ? 6
            : -1),
        l(e)._overflowDayOfYear && (a < 0 || 2 < a) && (a = 2),
        l(e)._overflowWeeks && -1 === a && (a = 7),
        l(e)._overflowWeekday && -1 === a && (a = 8),
        (l(e).overflow = a)),
      e
    );
  }
          ...
          e._w &&
            ...
            (function (e) {
              ...
              if (null != (a = e._w).GG || null != a.W || null != a.E)
                (r = 1),
                  (i = 4),
                  (t = sa(a.GG, e._a[0], xe(ya(), 1, 4).year)),
                  (s = sa(a.W, 1)),
                  ((n = sa(a.E, 1)) < 1 || 7 < n) && (_ = !0);
              else {
                (r = e._locale._week.dow), (i = e._locale._week.doy);
                var u = xe(ya(), r, i);
                (t = sa(a.gg, e._a[0], u.year)),
                  (s = sa(a.w, u.week)),
                  null != a.d
                    ? ((n = a.d) < 0 || 6 < n) && (_ = !0)
                    : null != a.e
  ...
  function ma(e) {
    var a,
      ...
      i,
      d = e._i,
      _ = ra.exec(d) || ia.exec(d);
    if (_) {
      for (l(e).iso = !0, a = 0, t = _a.length; a < t; a++)
        if (_a[a][1].exec(_[1])) {
          (n = _a[a][0]), (s = !1 !== _a[a][2]);
          break;
        }
      ...
      if (_[4]) {
        if (!da.exec(_[4])) return void (e._isValid = !1);
        i = "Z";
      }
      (e._f = n + (r || "") + (i || "")), ha(e);
    } else e._isValid = !1;
  ...
  function Ma(e) {
    ...
    if (n) {
      ...
      if (
        ...
        (s = e),
        (a = n[1]) &&
          We.indexOf(a) !== new Date(t[0], t[1], t[2]).getDay() &&
          ((l(s).weekdayMismatch = !0), !(s._isValid = !1)))
      )
        return;
      (e._a = r),
    ...
    if (e._f !== t.ISO_8601)
      if (e._f !== t.RFC_2822) {
        ...
        var a,
          ...
          c = m.length,
          M = 0;
        for (n = G(e._f, e._locale).match(F) || [], a = 0; a < n.length; a++)
          (r = n[a]),
            (s = (m.match(ue(r, e)) || [])[0]) &&
              (0 < (i = m.substr(0, m.indexOf(s))).length &&
                l(e).unusedInput.push(i),
              (m = m.slice(m.indexOf(s) + s.length)),
              (M += s.length)),
            J[r]
              ? (s ? (l(e).empty = !1) : l(e).unusedTokens.push(r),
                (d = r),
                (o = e),
                null != (_ = s) && u(me, d) && me[d](_, o._a, o, d))
              : e._strict && !s && l(e).unusedTokens.push(r);
  ...
  function Ya(e, a, t, r, i) {
    ...
    return (
      ...
      (_._f = a),
      (_._strict = r),
      (d = new y(ta(La(_))))._nextDay && (d.add(1, "d"), (d._nextDay = void 0)),
      d
    );
  }
  function ya(e, a, t, s) {
  ...
  Aa("Z", ":"),
    ...
    le(["Z", "ZZ"], function (e, a, t) {
      (t._useUTC = !0), (t._tzm = Sa(re, e));
    });
  var wa = /([\+\-]|\d\d)/gi;
  function Sa(e, a) {
    var t = (a || "").match(e);
    if (null === t) return null;
    var s = ((t[t.length - 1] || []) + "").match(wa) || ["-", 0, 0],
      n = 60 * s[1] + k(s[2]);
  ...
  function va(e, a) {
    ...
    return a._isUTC
      ? ((s = a.clone()),
        (n = (f(e) || d(e) ? e.valueOf() : ya(e).valueOf()) - s.valueOf()),
    ...
    return (
      ga(e)
        ...
        : "object" == typeof r &&
          ...
          ((n = (function (e, a) {
            ...
            return e.isValid() && a.isValid()
              ? ((a = va(a, e)),
                e.isBefore(a)
                  ? (t = za(e, a))
                  : (((t = za(a, e)).milliseconds = -t.milliseconds),
                    (t.months = -t.months)),
                t)
          ...
          (r.M = n.months)),
      (s = new Ta(r)),
      ga(e) && u(e, "_locale") && (s._locale = e._locale),
      s
    );
  }
  function Oa(e, a) {
    ...
    return function (t, s) {
      ...
      return (
        null === s ||
          ...
          (t = s),
          (s = n)),
        Fa(this, Ea((t = "string" == typeof t ? +t : t), s), e),
        this
      );
    };
  }
  function Fa(e, a, s, n) {
    ...
    e.isValid() &&
      ((n = null == n || n),
      d && be(e, fe(e, "Month") + d * s),
      i && pe(e, "Date", fe(e, "Date") + i * s),
  ...
  function Ra(e) {
    ...
    return void 0 === e
      ? this._locale._abbr
      : (null != (a = aa(e)) && (this._locale = a), this);
  }
  ...
  function qa(e, a, t) {
    return e < 100 && 0 <= e
      ? new Date(e + 400, a, t) - Ba
      : new Date(e, a, t).valueOf();
  }
  function Ka(e, a, t) {
    return e < 100 && 0 <= e ? Date.UTC(e + 400, a, t) - Ba : Date.UTC(e, a, t);
  }
  function Va(e, a) {
    R(0, [e, e.length], 0, a);
  }
  ...
  for (Qa = "S"; Qa.length <= 9; Qa += "S") le(Qa, at);
  ...
  (st.add = Na),
    (st.calendar = function (e, a) {
      var s = e || ya(),
        n = va(s, this).startOf("day"),
        r = t.calendarFormat(this, n) || "sameElse",
        i = a && (S(a[r]) ? a[r].call(this, s) : a[r]);
      return this.format(i || this.localeData().calendar(r, this, ya(s)));
    }),
    (st.clone = function () {
      return new y(this);
    }),
      ...
      switch (e) {
        ...
        case "hour":
          (a = this._d.valueOf()),
            (a +=
              36e5 -
              Ua(a + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5) -
              1);
          break;
        case "minute":
          (a = this._d.valueOf()), (a += 6e4 - Ua(a, 6e4) - 1);
          break;
        case "second":
          (a = this._d.valueOf()), (a += 1e3 - Ua(a, 1e3) - 1);
      }
    ...
    (st.from = function (e, a) {
      return this.isValid() && ((f(e) && e.isValid()) || ya(e).isValid())
        ? Ea({ to: this, from: e }).locale(this.locale()).humanize(!a)
    ...
    (st.to = function (e, a) {
      return this.isValid() && ((f(e) && e.isValid()) || ya(e).isValid())
        ? Ea({ from: this, to: e }).locale(this.locale()).humanize(!a)
        : this.localeData().invalidDate();
    }),
    (st.toNow = function (e) {
      return this.to(ya(), e);
    ...
    (st.set = function (e, a) {
      if ("object" == typeof e)
        for (
          var t = (function (e) {
              var a = [];
              for (var t in e) a.push({ unit: t, priority: O[t] });
              return (
                a.sort(function (e, a) {
    ...
    (st.startOf = function (e) {
      ...
      switch (e) {
        ...
        case "hour":
          (a = this._d.valueOf()),
            (a -= Ua(a + (this._isUTC ? 0 : 6e4 * this.utcOffset()), 36e5));
          break;
        case "minute":
          (a = this._d.valueOf()), (a -= Ua(a, 6e4));
          break;
        case "second":
          (a = this._d.valueOf()), (a -= Ua(a, 1e3));
      }
      return this._d.setTime(a), t.updateOffset(this, !0), this;
    }),
    (st.subtract = Ca),
    ...
    (st.hour = st.hours = qe),
    (st.minute = st.minutes = $a),
    (st.second = st.seconds = et),
    (st.millisecond = st.milliseconds = tt),
    (st.utcOffset = function (e, a, s) {
      var n,
        r = this._offset || 0;
      if (!this.isValid()) return null != e ? this : NaN;
      if (null == e) return this._isUTC ? r : Ha(this);
      if ("string" == typeof e) {
        if (null === (e = Sa(re, e))) return this;
      } else Math.abs(e) < 16 && !s && (e *= 60);
      return (
        !this._isUTC && a && (n = Ha(this)),
        (this._offset = e),
        (this._isUTC = !0),
        null != n && this.add(n, "m"),
        r !== e &&
          (!a || this._changeInProgress
            ? Fa(this, Ea(e - r, "m"), 1, !1)
    ...
    (st.hasAlignedHourOffset = function (e) {
      return (
        !!this.isValid() &&
        ((e = e ? ya(e).utcOffset() : 0), (this.utcOffset() - e) % 60 == 0)
      );
    }),
    (st.isDST = function () {
      return (
    ...
    (st.dates = g("dates accessor is deprecated. Use date instead.", Za)),
    (st.months = g("months accessor is deprecated. Use month instead", Ae)),
    (st.years = g("years accessor is deprecated. Use year instead", Ye)),
    (st.zone = g(
  ...
  function dt(e, a, t) {
    if ((i(e) && ((a = e), (e = void 0)), (e = e || ""), null != a))
      return it(e, a, t, "month");
    var s,
      n = [];
    for (s = 0; s < 12; s++) n[s] = it(e, s, t, "month");
    return n;
  }
  function _t(e, a, t, s) {
    "boolean" == typeof e
      ? i(a) && ((t = a), (a = void 0))
      : ((a = e), (e = !1), i((t = a)) && ((t = a), (a = void 0))),
      (a = a || "");
    var n,
      r = aa(),
      d = e ? r._week.dow : 0;
    if (null != t) return it(a, (t + d) % 7, s, "day");
    var _ = [];
    for (n = 0; n < 7; n++) _[n] = it(a, (n + d) % 7, s, "day");
    return _;
  }
  (rt.calendar = function (e, a, t) {
    ...
    (rt.invalidDate = function () {
      return this._invalidDate;
    }),
    (rt.ordinal = function (e) {
      return this._ordinal.replace("%d", e);
    }),
    (rt.preparse = nt),
    (rt.postformat = nt),
    (rt.relativeTime = function (e, a, t, s) {
      var n = this._relativeTime[t];
      return S(n) ? n(e, a, t, s) : n.replace(/%d/i, e);
    }),
    (rt.pastFuture = function (e, a) {
    ...
    (rt.months = function (e, a) {
      return e
        ? s(this._months)
          ? this._months[e.month()]
          : this._months[
              (this._months.isFormat || De).test(a) ? "format" : "standalone"
            ][e.month()]
        : s(this._months)
        ? this._months
        : this._months.standalone;
    }),
    (rt.monthsShort = function (e, a) {
      return e
        ? s(this._monthsShort)
          ? this._monthsShort[e.month()]
          : this._monthsShort[De.test(a) ? "format" : "standalone"][e.month()]
        : s(this._monthsShort)
        ? this._monthsShort
        : this._monthsShort.standalone;
    }),
    (rt.monthsParse = function (e, a, t) {
      var s, n, r;
      if (this._monthsParseExact)
        return function (e, a, t) {
          ...
          return t
            ? "MMM" === a
              ? -1 !== (n = Le.call(this._shortMonthsParse, i))
                ? n
                : null
              : -1 !== (n = Le.call(this._longMonthsParse, i))
              ? n
              : null
            : "MMM" === a
            ? -1 !== (n = Le.call(this._shortMonthsParse, i)) ||
    ...
    (rt.monthsRegex = function (e) {
      return this._monthsParseExact
        ? (u(this, "_monthsRegex") || ve.call(this),
          e ? this._monthsStrictRegex : this._monthsRegex)
        : (u(this, "_monthsRegex") || (this._monthsRegex = Se),
          this._monthsStrictRegex && e
            ? this._monthsStrictRegex
            : this._monthsRegex);
    }),
    (rt.monthsShortRegex = function (e) {
      return this._monthsParseExact
        ? (u(this, "_monthsRegex") || ve.call(this),
          e ? this._monthsShortStrictRegex : this._monthsShortRegex)
        : (u(this, "_monthsShortRegex") || (this._monthsShortRegex = we),
    ...
    (rt.firstDayOfYear = function () {
      return this._week.doy;
    }),
    (rt.firstDayOfWeek = function () {
      return this._week.dow;
    }),
    (rt.weekdays = function (e, a) {
      var t = s(this._weekdays)
        ? this._weekdays
        : this._weekdays[
      ...
      return !0 === e ? Oe(t, this._week.dow) : e ? t[e.day()] : t;
    }),
    (rt.weekdaysMin = function (e) {
      return !0 === e
    ...
    (rt.weekdaysParse = function (e, a, t) {
      var s, n, r;
      if (this._weekdaysParseExact)
        return function (e, a, t) {
          ...
          return t
            ? "dddd" === a
              ? -1 !== (n = Le.call(this._weekdaysParse, i))
                ? n
                : null
              : "ddd" === a
              ? -1 !== (n = Le.call(this._shortWeekdaysParse, i))
                ? n
                : null
              : -1 !== (n = Le.call(this._minWeekdaysParse, i))
              ? n
              : null
            : "dddd" === a
            ? -1 !== (n = Le.call(this._weekdaysParse, i)) ||
    ...
    (rt.weekdaysRegex = function (e) {
      return this._weekdaysParseExact
        ? (u(this, "_weekdaysRegex") || Re.call(this),
          e ? this._weekdaysStrictRegex : this._weekdaysRegex)
        : (u(this, "_weekdaysRegex") || (this._weekdaysRegex = Ne),
          this._weekdaysStrictRegex && e
            ? this._weekdaysStrictRegex
            : this._weekdaysRegex);
    }),
    (rt.weekdaysShortRegex = function (e) {
      return this._weekdaysParseExact
        ? (u(this, "_weekdaysRegex") || Re.call(this),
          e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
        : (u(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Ce),
          this._weekdaysShortStrictRegex && e
            ? this._weekdaysShortStrictRegex
            : this._weekdaysShortRegex);
    }),
    (rt.weekdaysMinRegex = function (e) {
      return this._weekdaysParseExact
        ? (u(this, "_weekdaysRegex") || Re.call(this),
          e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
        : (u(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Je),
    ...
    (t.lang = g("moment.lang is deprecated. Use moment.locale instead.", Qe)),
    (t.langData = g(
  ...
  var bt = gt("milliseconds"),
    ...
    jt = gt("years"),
    Pt = Math.round,
    xt = { ss: 44, s: 45, m: 45, h: 22, d: 26, M: 11 },
    Et = Math.abs;
  function Ot(e) {
    return (0 < e) - (e < 0) || +e;
  }
  function zt() {
    ...
    if (!m) return "P0D";
    var l = m < 0 ? "-" : "",
      c = Ot(this._months) !== Ot(m) ? "-" : "",
      M = Ot(this._days) !== Ot(m) ? "-" : "",
      h = Ot(this._milliseconds) !== Ot(m) ? "-" : "";
    return (
      l +
      "P" +
      (r ? c + r + "Y" : "") +
  ...
  (Wt.isValid = function () {
    ...
    (Wt.abs = function () {
      var e = this._data;
      return (
        (this._milliseconds = ut(this._milliseconds)),
        (this._days = ut(this._days)),
        (this._months = ut(this._months)),
        (e.milliseconds = ut(e.milliseconds)),
        (e.seconds = ut(e.seconds)),
        (e.minutes = ut(e.minutes)),
        (e.hours = ut(e.hours)),
        (e.months = ut(e.months)),
        (e.years = ut(e.years)),
        this
      );
    }),
    ...
    (Wt.as = function (e) {
      ...
      if ("month" === (e = x(e)) || "quarter" === e || "year" === e)
        switch (((a = this._days + s / 864e5), (t = this._months + lt(a)), e)) {
          case "month":
            return t;
          case "quarter":
            return t / 3;
    ...
    (t.updateLocale = function (e, a) {
      if (null != a) {
        var t,
          s,
          n = Ke;
        null != (s = $e(e)) && (n = s._config),
          ((t = new H((a = v(n, a)))).parentLocale = Ve[e]),
          (Ve[e] = t),
          Qe(e);
      } else
        null != Ve[e] &&
          (null != Ve[e].parentLocale
            ? (Ve[e] = Ve[e].parentLocale)
    ...
    (t.relativeTimeThreshold = function (e, a) {
      return (
        void 0 !== xt[e] &&
        (void 0 === a ? xt[e] : ((xt[e] = a), "s" === e && (xt.ss = a - 1), !0))
      );
    }),
  ...
  t.defineLocale("az", {
    ...
    ordinal: function (e) {
      ...
      var a = e % 10;
      return e + (Zt[a] || Zt[(e % 100) - a] || Zt[100 <= e ? 100 : null]);
    },
    week: { dow: 1, doy: 7 },
  }),
    t.defineLocale("be", {
  ...
  function ss(e, a, t) {
    ...
    return (
      ...
      2 !== e
        ? s
        : void 0 !== (r = { m: "v", b: "v", d: "z" })[(n = s).charAt(0)]
        ? r[n.charAt(0)] + n.substring(1)
        : n)
    );
  }
  function ns(e, a, t) {
  ...
  var rs =
    ...
    is = "led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro".split("_"),
    ds = [
      /^led/i,
      /^\xfano/i,
      /^b\u0159e/i,
  ...
  var Ls = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split(
      "_"
    ),
  ...
  var ps = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split(
      "_"
    ),
  ...
  var gs = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split(
    ...
    bs = "ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic".split("_"),
    As = [
      /^ene/i,
      /^feb/i,
      /^mar/i,
  ...
  t.defineLocale("es", {
    ...
    monthsShort: function (e, a) {
      return e ? (/-MMM-/.test(a) ? bs[e.month()] : gs[e.month()]) : gs;
    },
    monthsRegex: ws,
    monthsShortRegex: ws,
    monthsStrictRegex:
  ...
  var Es = "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split(
      "_"
    ),
    Os = "jan_feb_mrt_apr_mai_jun_jul_aug_sep_okt_nov_des".split("_");
  function zs(e, a, t, s) {
    var n = {
  ...
  t.defineLocale("fy", {
    ...
    monthsShort: function (e, a) {
      return e ? (/-MMM-/.test(a) ? Os[e.month()] : Es[e.month()]) : Es;
    },
    monthsParseExact: !0,
  ...
  function Gs(e) {
    return (e ? "" : "[múlt] ") + "[" + Rs[this.day()] + "] LT[-kor]";
  }
  function Bs(e) {
  ...
  function Us(e, a, t, s) {
    ...
    switch (t) {
      ...
      case "ss":
        return Bs(e) ? n + (a || s ? "sekúndur" : "sekúndum") : n + "sekúnda";
      case "m":
  ...
  function un(e, a, t, s) {
    ...
    return 1 === e
      ? n + rn(0, a, t[0], s)
      : a
      ? n + (dn(e) ? _n(t)[1] : _n(t)[0])
      : s
      ? n + _n(t)[1]
      : n + (dn(e) ? _n(t)[1] : _n(t)[2]);
  }
  t.defineLocale("lt", {
    months: {
      format:
    ...
    translate: function (e, a, t) {
      ...
      return 1 === t.length
        ? a
          ? s[0]
          : s[1]
        : e + " " + Mn.correctGrammaticalCase(e, s);
    },
  };
  function hn(e, a, t, s) {
    switch (t) {
  ...
  var wn = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split(
      "_"
    ),
  ...
  t.defineLocale("nl", {
    ...
    monthsShort: function (e, a) {
      return e ? (/-MMM-/.test(a) ? Sn[e.month()] : wn[e.month()]) : wn;
    },
    monthsRegex: Hn,
    monthsShortRegex: Hn,
    monthsStrictRegex:
  ...
  function zn(e, a, t) {
    ...
    switch (t) {
      case "ss":
        return s + (On(e) ? "sekundy" : "sekund");
      case "m":
        return a ? "minuta" : "minutę";
      case "mm":
        return s + (On(e) ? "minuty" : "minut");
      case "h":
        return a ? "godzina" : "godzinę";
      case "hh":
        return s + (On(e) ? "godziny" : "godzin");
      case "MM":
        return s + (On(e) ? "miesiące" : "miesięcy");
      case "yy":
        return s + (On(e) ? "lata" : "lat");
    }
  }
  function Wn(e, a, t) {
    var s = " ";
  ...
  var Cn = [
    ...
    Jn = ["آچر", "سومر", "اڱارو", "اربع", "خميس", "جمع", "ڇنڇر"];
  t.defineLocale("sd", {
    months: Cn,
    monthsShort: Cn,
    weekdays: Jn,
  ...
  function Bn(e, a, t, s) {
    ...
    switch (t) {
      ...
      case "ss":
        return a || s ? n + (Gn(e) ? "sekundy" : "sekúnd") : n + "sekundami";
      case "m":
        return a ? "minúta" : s ? "minútu" : "minútou";
      case "mm":
        return a || s ? n + (Gn(e) ? "minúty" : "minút") : n + "minútami";
      case "h":
        return a ? "hodina" : s ? "hodinu" : "hodinou";
      case "hh":
        return a || s ? n + (Gn(e) ? "hodiny" : "hodín") : n + "hodinami";
      case "d":
        return a || s ? "deň" : "dňom";
      case "dd":
        return a || s ? n + (Gn(e) ? "dni" : "dní") : n + "dňami";
      case "M":
    ...
    translate: function (e, a, t) {
      ...
      return 1 === t.length
        ? a
          ? s[0]
          : s[1]
        : e + " " + qn.correctGrammaticalCase(e, s);
    },
  };
    ...
    ordinal: function (e, a) {
      switch (a) {
        ...
        default:
          if (0 === e) return e + "'ıncı";
          var t = e % 10;
          return e + (er[t] || er[(e % 100) - t] || er[100 <= e ? 100 : null]);
      }
    },
    week: { dow: 1, doy: 7 },
  }),
  ...
  var nr = [
    ...
    rr = ["اتوار", "پیر", "منگل", "بدھ", "جمعرات", "جمعہ", "ہفتہ"];
  return (
    t.defineLocale("ur", {
      months: nr,
      monthsShort: nr,
  ...
  (function (e, a) {
    ...
    function o(e) {
      var a = 0,
        ...
        i = 0,
        d = 1;
      for (45 === e.charCodeAt(0) && ((a = 1), (d = -1)); a < s.length; a++)
    ...
    function y(e, a) {
      return e.offsetScore !== a.offsetScore
        ? e.offsetScore - a.offsetScore
        : e.abbrScore !== a.abbrScore
        ? e.abbrScore - a.abbrScore
        : a.zone.population - e.zone.population;
    }
    function f(e, a) {
      var t, s;
      for (m(a), t = 0; t < a.length; t++)
        (s = a[t]), (r[s] = r[s] || {}), (r[s][e] = !0);
    }
    function p(e) {
      var a,
        t,
    ...
    function D(e) {
      var a, s, r, i;
      for ("string" == typeof e && (e = [e]), a = 0; a < e.length; a++)
        (i = k((s = (r = e[a].split("|"))[0]))),
          (t[i] = e[a]),
          (n[i] = s),
          f(i, r[2].split(" "));
    ...
    function T(e, a) {
      ...
      return i instanceof M
        ...
        ? ((i = new M(i)), (t[e] = i), i)
        : s[e] && a !== T && (r = T(s[e], T))
        ? ((i = t[e] = new M())._set(r), (i.name = n[e]), i)
        : null;
    }
    function g(e) {
      var a, t, r, i;
    ...
    function S(a) {
      ...
      return (
        n && !e.isMoment(a) && A(r) && r.add(n.parse(r), "minutes"), r.tz(s), r
      );
    }
    (d < 2 || (2 === d && _ < 6)) &&
      w(
      ...
      (M.prototype = {
        ...
        _index: function (e) {
          var a,
            t = +e,
            s = this.untils;
          for (a = 0; a < s.length; a++) if (t < s[a]) return a;
        },
        parse: function (e) {
          var a,
            t,
          ...
          for (n = 0; n < _; n++)
            if (
              ...
              (t = i[n + 1]),
              (s = i[n ? n - 1 : n]),
              a < t && S.moveAmbiguousForward
                ? (a = t)
                : a > s && S.moveInvalidForward && (a = s),
              r < d[n] - 6e4 * a)
            )
              return i[n];
          return i[_];
              ...
              var t,
                ...
                i = (function () {
                  var e,
                    a,
                    t,
                    s = new Date().getFullYear() - 2,
                    n = new h(new Date(s, 0, 1)),
                    r = [n];
                  for (t = 1; t < 48; t++)
                    (a = new h(new Date(s, t, 1))).offset !== n.offset &&
                      ((e = Y(n, a)),
                      r.push(e),
    ...
    (e.tz = S),
        ...
        if (
          (void 0 === a._z &&
            (n &&
              A(a) &&
              !a._isUTC &&
              ((a._d = e.utc(a._a)._d), a.utc().add(n.parse(a), "minutes")),
            (a._z = n)),
          a._z)
        )
          if (
      ...
      (H.utcOffset =
        ...
        function () {
          return (
            arguments.length > 0 && (this._z = null), v.apply(this, arguments)
          );
        })),
